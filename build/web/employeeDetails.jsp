    ...
    <jsp:include page="menu.jsp"></jsp:include>
        ...
        <div id="example">
            ...
            <div class="bootstrap-table bootstrap5">
                <div ><div class="bs-bars float-left">
                ...
                <div class="container">
                    <div class="table-container " style="height: 100vh; padding-bottom: 50.5px;">

                        <div>
                            <table id="table" data-height="400" data-virtual-scroll="true" class="table table-bordered table-hover" style="margin-top: 15px;">
                                <thead>
                                <c:choose>
                                    <c:when test = "${noData}">
                                        <tr>
                            ...
                            <tbody>
                                <c:forEach items='${EmpList}' var="emp">
                                    <tr data-index="0">
                                        ...
                                        <td><c:out value="${emp.carAllowence}"> </c:out></td>
                    ...
                    <!--                    <div class="table-pagination" style="display: none;"></div>-->
                </div>
            </div>
